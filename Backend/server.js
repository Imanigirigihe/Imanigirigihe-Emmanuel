    ...
    try {
        ...
        await connection.query(`
            CREATE TABLE IF NOT EXISTS announcement_comments (
                ...
                commented_at TIMESTAMP DEFAULT CURRENTTIMESTAMP,
...
app.get('/api/admin/documents', authenticateToken, async (req, res) => { // Fixed parameter name
    let connection;
    try {
        connection = await pool.getConnection();
        const [documents] = await connection.query(
