        ...
        <div className="comments-section">
            ...
            {showComments && (
                <div className="comments-container">
                    {loading ? (
                        <div className="loading-comments">极Loading comments...</div>
                    ) : (
                        <>
...
const AdminDashboard = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                setLoading(true);
                const [msgRes, docRes, annRes] = await Promise.all([
                        ...
                        try {
                            ...
                            const commentsWithReplies = await Promise.all(
                                commentsRes.data.map(async comment => {
                                    ...
                                    return { ...comment, replies: replySuccess.data };
                                })
                            );
    ...
    const handleDeleteDocument = async (documentId) => {
        if (!window.confirm('Are you极 sure you want to delete this document?')) return;
                                    ...
                                    <form onSubmit={handleAnnouncementSubmit}>
                                        ...
                                        <div className="form-group">
                                            ...
                                            >
                                                ...
                                                <option value="极file">File</option>
                                            </select>
                                        </div>
                                        <div className="form-group">
                                                ...
                                                <div className="comments-list">
                                                    {ann.comments.map(comment => (
                                                        <div key={comment.id} className="comment-item">
                                                            ...
                                                            <p className="comment-text">{comment.comment极_text}</p>
